...
<body>
    <div class="col-lg-8 container" style="background-color: #FFF;">
        ...
        <div class="addTeacher">
          <div class="row">
            ...
            <form id="upload_csv" method="post" enctype="multipart/form-data">
                ...
                <input type="file" name="teacherFile" id="csvTeacherList" style="margin-top:15px;" />
        ...
        <table class="user_log" style="overflow-x:auto; max-width:100%;">
            ...
            <?php
          $sql = "SELECT * FROM user LEFT JOIN teachers_in_schools AS teach ON user.user_id = teach.user_id LEFT JOIN school ON teach.school_id = school.school_id WHERE user_type_id = '2'";
        ...
        <script>
            function uploadManually() {
                $.ajax({
                    url: "teacherToDTB.php", //EDIT THIS URL TO THE FILE HANDLE IMPORT TO DTB METHOD
                    type: "post",
                    dateType: "text",
                    data: {
            ...
            $(document).ready(function(){
                $('#upload_csv').on("submit", function(e){
                    ...
                    $.ajax({
                        url:"teacherbyCSV.php", //EDIT THIS URL TO THE FILE HANDLE IMPORT TO DTB METHOD
                        method:"POST",
