    ...
    <div class="col-lg-8 container" style="background-color: #FFF;">
          ...
          <div class="row">
            ...
            <table class="register">
              <tr>
                ...
                <input type="text" class="form-control mb-2 mr-sm-2 mb-sm-0" id="name" name="studentName" placeholder="Name" required>
              </td>
                <td>
                <label class="sr-only" for="surName">Surname</label>
                <input type="text" class="form-control mb-2 mr-sm-2 mb-sm-0" id="surName" name="studentSurname" placeholder="Surname" required>
                </td>
                <td>
                <label class="sr-only" for="email">Email</label>
                <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                    <div class="input-group-addon">@</div>
                    <input type="text" class="form-control" id="email" name="studentEmail" placeholder="Useremail" required>
                    </td>
                </div>
                <td>
          ...
          <form name="year" class="form-inline" method="post">
              <div class="text-sm-center">
                <select class="custom-select mb-2 mr-sm-2 mb-sm-0 year" name="year" id="year">
                    <?php
                    $query = "SELECT Starting_year FROM student";
                    $result = mysqli_query($conn, $query);
                    while($row = mysqli_fetch_array($result))
                    {
                       echo  "<option value=". $row["Starting_year"] ." selected>".$row["Starting_year"]."</option>";
                    }
                    ?>
        ...
        <!-- Student list -->
          <table class="user_log" style="overflow-x:auto; max-width:100%;">
            ...
            $sql = "SELECT us.user_id as userid, us.First_name as First_name, us.Last_name as Last_name, us.Email as Email, scl.Name as school_name, stu.Starting_year as Year FROM user AS us LEFT JOIN student AS stu ON stu.user_id = us.user_id LEFT JOIN school AS scl ON stu.school_id = scl.school_id WHERE user_type_id ='3' AND scl.school_id = '$sID' ";
