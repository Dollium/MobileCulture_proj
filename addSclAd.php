  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      ?>
        ...
        <!-- /navbar -->
          <div class="centered bordered container" style="background-color:#f3f3f5; padding-bottom: 50px;">
          <br>
            <div style="padding-bottom: 40px;">
              <div class="form-inline">
                ...
                <?php
                 ...
                 if(!empty($_SESSION['success_registration'])){
                  ...
                  ?>
                  <!-- Select school which user will be added to -->
                    ...
                    <tr>
                      <td>
                        ...
                        <td>
                          ...
                          <input type="text" pattern="[a-zåäöA-ZÅÄÖ]+" class="form-control mb-2 mr-sm-2 mb-sm-0" id="name" name="name" placeholder="Nimi">
                        </td>
                        <td>
                          <label class="sr-only" for="surName">Sukunimi</label>
                          <input type="text" pattern="[a-zåäöA-ZÅÄÖ]+" class="form-control mb-2 mr-sm-2 mb-sm-0" id="surname" name="surname" placeholder="Sukunimi">
                        </td>
                        <td>
                          <label class="sr-only" for="email">Sähköposti</label>
                          <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                            <div class="input-group-addon">@</div>
                            <input type="text" class="form-control" id="email" name="email" placeholder="Sähköposti">
                          </td>
                        </div>
                        <td>
              ...
              <form action="Delete.php" method="post">
                ...
                $sql = "SELECT * FROM user AS us
                LEFT JOIN school_admin_users AS sclad
                ON us.user_id = sclad.school_admin_id
                LEFT JOIN school AS scl
                ON scl.school_id = sclad.school_id
                WHERE user_type_id = '1'
                ORDER BY sclad.school_id ASC, us.Last_name ASC";
